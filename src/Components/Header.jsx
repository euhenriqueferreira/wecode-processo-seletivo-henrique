...
export function Header() {
    ...
    return (
        <header className='header'>
            <div className={`headerWrapper ${menuHoveredStyle ? 'hovered' : ''}`} onMouseEnter={handleMouseEnterHeader} onMouseLeave={handleMouseLeaveHeader}>
                <div className="logo">
                    <svg width="136" height="32" viewBox="0 0 136 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_7007_385)">
                ...
                <div className="quickLinks">
                    <ul>
                        <li>
                            <a href="">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_3006_1594)">
                        ...
                        <li>
                            <a href="">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_7007_375)">
